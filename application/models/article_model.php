<?php  
    ...
    */
	class Article_Model extends CI_Model
	{
		...
		{
			$this->db->select('tbl_cyberits_t_articles.articleID as articleID,title, DATE_FORMAT(tbl_cyberits_t_articles.created,\'%d %b %y\') AS created ,username ,view ,LEFT(content, \'100\') AS content ,AVG(rating) as ratingPerArticle, categoryImgLink');
		...
		{
			$this->db->select('DATE_FORMAT(tbl_cyberits_t_comments.created,\'%d %b %y\') AS created, name, rating, comment');
